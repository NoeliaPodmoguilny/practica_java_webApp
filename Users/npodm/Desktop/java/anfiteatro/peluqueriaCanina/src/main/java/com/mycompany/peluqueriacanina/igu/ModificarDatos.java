...
public class ModificarDatos extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(41, 41, 41)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnLimpiar, javax.swing.GroupLayout.DEFAULT_SIZE, 83, Short.MAX_VALUE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.modificarMascota(masco, nombreMascota, raza, color, duenio, telefono, observaciones, alergico, atEspe);
        ...
        //para cerrar la ventana luego de editar
        this.dispose();
    ...
    private void CargarDatos(int idMascota) {
        ...
        txtDuenio.setText(masco.getUnDuenio().getNombreDuenio());
        txtTelef.setText(masco.getUnDuenio().getTelefono());
        txtObservaciones.setText(masco.getObservaciones());
        
        if(masco.getAtencionEspe().equals("Si")){
        ...
        if(masco.getAtencionEspe().equals("Si")){
            cmbAtEspe.setSelectedIndex(1);
        }else if(masco.getAtencionEspe().equals("No")){
            cmbAtEspe.setSelectedIndex(2);
        }
    }
