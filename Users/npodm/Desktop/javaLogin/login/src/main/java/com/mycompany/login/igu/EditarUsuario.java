...
public class EditarUsuario extends javax.swing.JFrame {
    ...
    public EditarUsuario(int idUser, Controladora control) {
        initComponents();
        this.idUser = idUser;
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.editarUsuario(us, usuario,contras,rol);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        //buscar usuario
        us = control.traerUsuario(idUser);
        //carga de datos en interfaz
        txtNombreUs.setText(us.getNombre());
        txtPassUs.setText(us.getContrasenia());
        
        //caragr roles de forma generica
        ...
        String rol = us.getUnRol().getNombreRol();
